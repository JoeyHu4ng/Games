...
class Minesweeper:
    ...
    def __init__(self, master, title="Minesweeper"):
        ...
        self.dead_mine = tk.PhotoImage(file="dead_mine.png")
        self.wrong_mine = tk.PhotoImage(file="wrong_mine.png")
        self.smile = tk.PhotoImage(file="smile.png")
        self.over = tk.PhotoImage(file="over.png")
        self.cool = tk.PhotoImage(file="cool.png")
